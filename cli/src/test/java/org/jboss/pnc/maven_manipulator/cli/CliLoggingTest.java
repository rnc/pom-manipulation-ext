...
public class CliLoggingTest {
    ...
    public void testLogfile() throws Exception {
        ...
        try {
            ...
            c.run(
                    new String[] {
                            "-d",
                            "--settings=" + getClass().getResource("/settings-test.xml").getPath(),
                            "-Dmaven.repo.local=" + folder,
                            "--log",
    ...
    @BMRule(
            ...
            action = "return org.jboss.pnc.maven_manipulator.cli.CliLoggingTest.PODMAN_MAP")
    ...
    @BMRule(
            ...
            targetLocation = "AT ENTRY",
            action = "return org.jboss.pnc.maven_manipulator.cli.CliLoggingTest.getCgroupDocker()")
    ...
    @BMRule(
            ...
            targetMethod = "getCGroups()",
            targetLocation = "AT ENTRY",
            action = "return org.jboss.pnc.maven_manipulator.cli.CliLoggingTest.getCgroupKube()")
