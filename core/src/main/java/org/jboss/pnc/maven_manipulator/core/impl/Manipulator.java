...
/**
 * Represents one way that a POM may be manipulated/modified during pre-processing. State is kept separately for each
 * {@link Manipulator}
 * (see {@link VersioningState}, associated with the {@link ProjectVersioningManipulator} implementation of this
 * interface). State is stored in the
 * {@link ManipulationSession} instance. State consists of both configuration (normally detected from the user
 * properties, or -D options on the command
 ...
 * important in terms of order, the
...
public interface Manipulator {
    ...
    /**
     * Apply any changes to the raw models (stored in the {@link ManipulationSession} related to the given list of
