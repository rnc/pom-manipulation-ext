...
import org.jboss.pnc.mavenmanipulator.core.state.PluginInjectingState;
import org.jboss.pnc.mavenmanipulator.core.state.State;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Simple manipulator that detects the presence of the
 * <a href="https://github.com/project-ncl/project-sources-maven-plugin">project-sources-maven-plugin</a>,
 * and injects it into the base build if it's not present. This plugin will simply create a source archive for the
 * project sources AFTER this extension
 * has run, but BEFORE any sources are altered or generated by the normal build process. Configuration consists of a
 * couple of properties, documented
...
public class PluginInjectingManipulator
    ...
    private static final String PROJECT_SOURCES_GID = "org.jboss.pnc";
    ...
    /**
     * If enabled, grab the execution root pom (which will be the topmost POM in terms of directory structure). Check
     * for the
     * presence of the project-sources-maven-plugin in the base build (/project/build/plugins/). Inject a new plugin
     * execution for creating project
