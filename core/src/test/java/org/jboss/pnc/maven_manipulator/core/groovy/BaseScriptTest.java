...
import static org.jboss.pnc.maven_manipulator.core.fixture.TestUtils.INTEGRATION_TEST;
import static org.jboss.pnc.maven_manipulator.core.fixture.TestUtils.ROOT_DIRECTORY;
...
import org.jboss.pnc.maven_manipulator.core.impl.FinalGroovyManipulator;
import org.jboss.pnc.maven_manipulator.core.impl.InitialGroovyManipulator;
...
public class BaseScriptTest {
    ...
    public void testGroovyAnnotation() throws Exception {
        ...
        final File groovy = Paths.get(INTEGRATION_TEST.toString(), "src", "it", "setup", "depMgmt1", "Sample.groovy")
                .toFile();
        ...
        TestUtils.executeMethod(
                gm,
                "applyGroovyScript",
                new Class[] { List.class, Project.class, File.class },
