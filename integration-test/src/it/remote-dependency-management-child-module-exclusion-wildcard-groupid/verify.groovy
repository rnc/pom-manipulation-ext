...
assert junitDependency.version.text() == "4.1"
...
def commonsChildDependency = pomChild.dependencyManagement.dependencies.dependency.find { it.artifactId.text() == "commons-lang" }
assert commonsChildDependency != null
assert commonsChildDependency.version.text() == "2.0"
